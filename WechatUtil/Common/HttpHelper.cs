...
namespace WechatUtil.Common.Helper
{
    ...
    public static class JsonExtention
    {
        ...
        public static string ToQuery(this object jsonObject)
        {
            PropertyInfo[] propertis = jsonObject.GetType().GetProperties();
            StringBuilder sb = new StringBuilder();
            foreach (var p in propertis)
            {
                var v = p.GetValue(jsonObject, null);
                if (v == null)
                    continue;
